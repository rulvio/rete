defmodule Rete.MixProject do
  ...
  defp docs do
    [
      ...
      # Names with no page to link to. The first is private, and the second is hidden in
      # OTP. The rest no longer exist, and only a changelog entry or a design note names
